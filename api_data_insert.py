...
# db.clothes.insert_one({'low_TMP': -100, 'high_TMP': 5, 'clothes': '패딩, 목도리, 장갑, 기모바지', 'msg': '최대한 따뜻하게 입으세요!', 'img': 'r4'})
# db.clothes.insert_one({'low_TMP': 6, 'high_TMP': 9, 'clothes': '겨울코트, 경량패딩, 가죽자켓, 발열 내의', 'msg': '두꺼운 외투를 입으세요!', 'img': 'r8'})
...
# db.clothes.insert_one({'low_TMP': 23, 'high_TMP': 26, 'clothes': '얇은 긴팔, 얇은 셔츠, 반팔, 면바지&반바지', 'msg': '반팔을 꺼낼 시간~', 'img': 'r27'})
# db.clothes.insert_one({'low_TMP': 27, 'high_TMP': 100, 'clothes': '민소매, 반팔, 반바지, 린넨', 'msg': '얇고 시원하게!', 'img': 'r28'})
